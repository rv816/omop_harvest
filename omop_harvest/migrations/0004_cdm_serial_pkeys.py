...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.location_id'
        db.alter_column(u'location', 'location_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'PayerPlanPeriod.payer_plan_period_id'
        db.alter_column(u'payer_plan_period', 'payer_plan_period_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Person.person_id'
        db.alter_column(u'person', 'person_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Cohort.cohort_id'
        db.alter_column(u'cohort', 'cohort_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'ProcedureOccurrence.procedure_occurrence_id'
        db.alter_column(u'procedure_occurrence', 'procedure_occurrence_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'VisitOccurrence.visit_occurrence_id'
        db.alter_column(u'visit_occurrence', 'visit_occurrence_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'ProcedureCost.procedure_cost_id'
        db.alter_column(u'procedure_cost', 'procedure_cost_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Provider.provider_id'
        db.alter_column(u'provider', 'provider_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'DrugCost.drug_cost_id'
        db.alter_column(u'drug_cost', 'drug_cost_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'CareSite.care_site_id'
        db.alter_column(u'care_site', 'care_site_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'ConditionEra.condition_era_id'
        db.alter_column(u'condition_era', 'condition_era_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'DrugExposure.drug_exposure_id'
        db.alter_column(u'drug_exposure', 'drug_exposure_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'ConditionOccurrence.condition_occurrence_id'
        db.alter_column(u'condition_occurrence', 'condition_occurrence_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Organization.organization_id'
        db.alter_column(u'organization', 'organization_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'DrugEra.drug_era_id'
        db.alter_column(u'drug_era', 'drug_era_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Observation.observation_id'
        db.alter_column(u'observation', 'observation_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'ObservationPeriod.observation_period_id'
        db.alter_column(u'observation_period', 'observation_period_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Location.location_id'
        db.alter_column(u'location', 'location_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'PayerPlanPeriod.payer_plan_period_id'
        db.alter_column(u'payer_plan_period', 'payer_plan_period_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Person.person_id'
        db.alter_column(u'person', 'person_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Cohort.cohort_id'
        db.alter_column(u'cohort', 'cohort_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'ProcedureOccurrence.procedure_occurrence_id'
        db.alter_column(u'procedure_occurrence', 'procedure_occurrence_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'VisitOccurrence.visit_occurrence_id'
        db.alter_column(u'visit_occurrence', 'visit_occurrence_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'ProcedureCost.procedure_cost_id'
        db.alter_column(u'procedure_cost', 'procedure_cost_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Provider.provider_id'
        db.alter_column(u'provider', 'provider_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'DrugCost.drug_cost_id'
        db.alter_column(u'drug_cost', 'drug_cost_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'CareSite.care_site_id'
        db.alter_column(u'care_site', 'care_site_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'ConditionEra.condition_era_id'
        db.alter_column(u'condition_era', 'condition_era_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'DrugExposure.drug_exposure_id'
        db.alter_column(u'drug_exposure', 'drug_exposure_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'ConditionOccurrence.condition_occurrence_id'
        db.alter_column(u'condition_occurrence', 'condition_occurrence_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Organization.organization_id'
        db.alter_column(u'organization', 'organization_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'DrugEra.drug_era_id'
        db.alter_column(u'drug_era', 'drug_era_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Observation.observation_id'
        db.alter_column(u'observation', 'observation_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'ObservationPeriod.observation_period_id'
        db.alter_column(u'observation_period', 'observation_period_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
